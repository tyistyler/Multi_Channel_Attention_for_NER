...
class Trainer(object):
    ...
    def __init__(self, train_data,
                 model, optimizer=None, loss=None,
        ...
        self.ngram_train_examlpes = ngram_train_examlpes
        self.ngram_dev_examlpes = ngram_dev_examlpes
        ...
        if self.dev_data is not None:
            self.tester = Tester(model=self.model,
                                 ...
                                 ngram_test_examlpes=self.ngram_dev_examlpes,
                                 args=self.args,
    ...
    def train(self, load_best_model=True, on_exception='auto'):
        ...
        try:
            ...
            # print("self._model_device",self._model_device)
    ...
    def get_ngram_data(self, indices, max_seq_len):
        ...
        for index in indices:
            input_ids, input_mask, _, _, word_ids, matching_matrix, channel_ids, _, _ = self.ngram_train_examlpes[index]
        ...
        with inner_tqdm(total=self.n_steps, postfix='loss:{0:<6.5f}', leave=False, dynamic_ncols=True) as pbar:
            ...
            for epoch in range(1, self.n_epochs + 1):
                ...
                for indices, batch_x, batch_y in data_iterator:
                    ...
                    # NER---------------------------------------------------------------------------
                    prediction = self._data_forward(self.model, batch_x=batch_x)
                    ...
                    #    print(batch_y)
                    loss = self._compute_loss(prediction, batch_y).mean()  # 默认使用'loss'，而不是'cws_loss'
