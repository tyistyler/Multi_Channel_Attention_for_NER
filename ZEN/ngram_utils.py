...
MSRNGRAM_DICT_NAME = 'resume_ngram_from_tencent_4.txt'
        ...
        with open(ngram_freq_path, "r", encoding="utf-8") as fin:
            for i, line in enumerate(fin):
                ...
                if tokens:
                    ...
                    count += 1
                    self.id_to_ngram_list.append(tokens)
                    self.ngram_to_id_dict[tokens] = len(self.ngram_to_id_dict)
                    self.id_to_ngram_dict[len(self.ngram_to_id_dict)] = tokens
        print("ngram_to_id_dict: ", len(self.ngram_to_id_dict))
        # print("count: ", count)
        # print("res:  ",len(res))
